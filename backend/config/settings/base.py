...
# Database
DATABASE_URL = config('DATABASE_URL', default='postgresql://admin:admin123@localhost:5432/procure_db')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@procure.com')
