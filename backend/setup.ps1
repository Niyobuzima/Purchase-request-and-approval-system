...
Write-Host "   uv run migrate" -ForegroundColor Cyan
Write-Host ""
Write-Host "4. Create superuser:" -ForegroundColor White
Write-Host "   uv run createsuperuser" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "   uv run migrate          # Run migrations" -ForegroundColor Cyan
Write-Host "   uv run makemigrations   # Create migrations" -ForegroundColor Cyan
Write-Host "   uv run shell            # Django shell" -ForegroundColor Cyan
Write-Host "   uv run test             # Run tests" -ForegroundColor Cyan
Write-Host "   uv run coverage         # Test coverage" -ForegroundColor Cyan
Write-Host "   uv run format           # Format code" -ForegroundColor Cyan
Write-Host "   uv run lint             # Lint code" -ForegroundColor Cyan
Write-Host "   uv run celery-worker    # Start Celery worker" -ForegroundColor Cyan
Write-Host ""
